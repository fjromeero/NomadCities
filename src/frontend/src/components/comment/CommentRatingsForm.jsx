...
export default function CommentRatingsForm({ratings, setRatings, setCreationStep, cancelCreation}) {
    return (
        <div className="w-full m-auto flex flex-col gap-20 py-20">
            <header>
                <h1 className="text-3xl font-bold">Share how things went</h1>
                <p className="pt-4 text-lg">Tell future nomads what you loved about your stay</p>
            </header>
            <section>
                ...
                <StarForm rating={ratings.internetConnection} setRating={(value) => {
                    setRatings((prev) => {
                        return {
                            "internetConnection": value,
                            "coworkingSpaces": prev.coworkingSpaces,
                            "healthService": prev.healthService,
                            "safety": prev.safety,
                            "gastronomy": prev.gastronomy,
                            "meansOfTransport": prev.meansOfTransport,
                            "foreignFriendly": prev.foreignFriendly,
                        }
                    })
                }} />
            </section>
            <section>
                <header className="flex items-center gap-3 pb-6">
                    <h1 className="text-3xl font-bold">Coworking spaces</h1>
                    <svg
                        fill="white"
                        viewBox="0 0 16 16"
                        className="w-9 h-9"
                ...
                <StarForm rating={ratings.coworkingSpaces} setRating={(value) => {
                    setRatings((prev) => {
                        return {
                            "internetConnection": prev.internetConnection,
            ...
            <section>
                ...
                <StarForm rating={ratings.healthService} setRating={(value) => {
                    setRatings((prev) => {
                        return {
                            "internetConnection": prev.internetConnection,
                            "coworkingSpaces": prev.coworkingSpaces,
            ...
            <section>
                ...
                <StarForm rating={ratings.safety} setRating={(value) => {
                    setRatings((prev) => {
                        return {
                            "internetConnection": prev.internetConnection,
                            "coworkingSpaces": prev.coworkingSpaces,
            ...
            <section>
                <header className="flex items-center gap-3 pb-6">
                    <h1 className="text-3xl font-bold">Gastronomy</h1>
                    <svg
                        viewBox="0 0 20 20"
                        fill="white"
                        className="w-9 h-9"
                ...
                <StarForm rating={ratings.gastronomy} setRating={(value) => {
                    setRatings((prev) => {
                        return {
                            "internetConnection": prev.internetConnection,
                            "coworkingSpaces": prev.coworkingSpaces,
            ...
            <section>
                <header className="flex items-center gap-3 pb-6">
                    <h1 className="text-3xl font-bold">Means of transport</h1>
                    <svg
                ...
                <StarForm rating={ratings.meansOfTransport} setRating={(value) => {
                    setRatings((prev) => {
                        return {
                            "internetConnection": prev.internetConnection,
                            "coworkingSpaces": prev.coworkingSpaces,
            ...
            <section>
                <header className="flex items-center gap-3 pb-6">
                    <h1 className="text-3xl font-bold">Foreign Friendly</h1>
                    <svg
                        viewBox="0 0 24 24"
                        fill="white"
                        className="w-9 h-9"
                ...
                <StarForm rating={ratings.foreignFriendly} setRating={(value) => {
                    setRatings((prev) => {
                        return {
                            "internetConnection": prev.internetConnection,
                            "coworkingSpaces": prev.coworkingSpaces,
